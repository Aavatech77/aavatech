...
const Testimonials = () => {
  return (
    <div className="grid place-content-center px-2">
      <section className="inline-flex gap-4 my-6 md:my-12 py-8 lg:py-10 overflow-x-auto scroll-smooth snap-x snap-mandatory">
        {testimonials.map((item, index) => (
          <div
            className="rounded-3xl p-2 relative bg-[#4874AE1A]/10 shadow-xl max-w-xs sm:max-w-sm flex-shrink-0 snap-center"
            key={index}
          >
            <Image
              src={item.img}
